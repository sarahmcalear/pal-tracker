...
public class TimeEntryControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        CounterService counterMock = Mockito.mock(CounterService.class);
        GaugeService gaugeMock = Mockito.mock(GaugeService.class);

        controller = new TimeEntryController(timeEntryRepository, counterMock, gaugeMock);
    }
